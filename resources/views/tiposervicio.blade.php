...
<div class="container-tipoServicio">
    ...
    <div class="col-md-12">
            <div class="card15">
                <div class="card-header-tp p-1">{{ __('Registro tipo de servicio') }}</div><br>
        ...
        <div class="col-md-12">
            ...
            <div class="card16">
                <div class="card-header p-1">{{ __('Listado de tipos de servicios') }}</div>
        ...
        @csrf
                    <table class="table-tp table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" action="{{ url('editar_tipo_servicio',$d['id_tipo_servicio']) }}" id="studentForm_{{$d['id_tipo_servicio']}}">
                                {{ method_field('GET') }}
                                {{  csrf_field() }}
                            ...
                            @if($d['estado'] == 1)   
                              <td>
                            <a href="{{ url('inhabilitar_tipo_servicio/'.$d['id_tipo_servicio'].'') }}"
                            ...
                            @else
                              <td>
                            <a href="{{ url('habilitar_tipo_servicio/'.$d['id_tipo_servicio'].'') }}"
