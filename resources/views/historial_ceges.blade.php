...
<h6 class="card-header p-1">Seleccionar informe ceges a consultar</h6>
  ...
  <div class="card-body6">
      ...
      <form method="POST" action="{{ url('historial_ceges_detalle') }}">
        @csrf

        <br>
          <div class="row mb-6">
                            <label for="fecha_consulta" class="col-md-1 col-form-label text-center" style="height:2rem;">{{ __('Fecha') }}</label><br><br>
